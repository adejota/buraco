...
@section('content')
<div id="register" class="p-4">
    <div class="center-page">

        <div id="img-container" class="w-100 d-flex justify-content-center align-items-center p-5 mt-3">
            <svg class="w-75" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 924.202 649.971">
        ...
        <form id="form-container" method="POST" action="{{ route('register') }}">
            @csrf
    
            <div>
                <label class="form-label fs-3 m-0" for="name">{{ __('Usuário') }}</label>
    
                <div class="input-group input-group-lg mb-3">
                    <input id="name" type="text" class="fs-1 mt-3 form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
            ...
            <div>
                <label class="form-label fs-3 m-0" for="email">{{ __('E-mail') }}</label>
    
                <div class="input-group input-group-lg mb-3">
                    <input id="email" type="email" class="fs-1 mt-3 form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
            ...
            <div>
                <label class="form-label fs-3 m-0" for="password">{{ __('Senha') }}</label>
    
                <div class="input-group input-group-lg mb-3">
                    <input id="password" type="password" class="fs-1 mt-3 form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
            ...
            <div class="input-group input-group-lg mb-5">
                <label class="form-label fs-3 m-0" for="password-confirm">{{ __('Confirme sua senha') }}</label>
    
                <div class="input-group input-group-lg mb-3">
                    <input id="password-confirm" type="password" class="fs-1 mt-3 form-control" name="password_confirmation" required autocomplete="new-password">
                </div>
            </div>
    
            <div class="d-flex justify-content-center mb-4 mt-5">
                <button type="submit" class="btn w-100 m-0 rounded-pill">
                    {{ __('Criar conta') }}
                </button>
            </div>
        </form>
