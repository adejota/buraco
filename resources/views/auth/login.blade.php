...
<div id="login" class="p-4">
    <div class="center-page w-100">
        ...
        <form id="form-container" method="POST" action="{{ route('login') }}">
            @csrf

            <div>
                <label class="form-label fs-3 m-0" for="email">{{ __('E-mail') }}</label>
                <div class="input-group input-group-lg mb-3">
                    <input id="email" type="email" class="fs-1 mt-3 form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
            ...
            <div>
                ...
                <div class="input-group input-group-lg mb-3">
                    <input id="password" type="password" class="fs-1 mt-3 form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
            ...
            <div class="buttons-container d-flex w-100 justify-content-between">
                
                <button type="button" class="w-100 rounded-pill">
                    <a href="{{ route('register') }}" class="register btn w-100 rounded-pill">
                        {{ __('Criar conta') }}
                    </a>
                </button>
                ...
                <button type="submit" class="w-100 rounded-pill">
                    {{ __('Login') }}
                </button>
            </div>
            
            <div id="password-request" class="d-flex justify-content-center align-items-center fs-3">
